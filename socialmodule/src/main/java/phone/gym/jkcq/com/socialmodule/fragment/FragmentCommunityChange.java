...
public class FragmentCommunityChange extends BaseMVPFragment<AddDynamView, AddDynamPresent> implements CommonAliView, AddDynamView {
    ...
    ViewPager2 viewPager_community;
    ...
    protected void initView(View view) {
        ...
        viewPagerAdapter = new ViewPagerFragmentStateAdapter(getChildFragmentManager(), this.getLifecycle());
    ...
    class ViewPagerFragmentStateAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            ...
            if (position == 0) {
                return PageFollowFragment.newInstance("", position, JkConfiguration.DynamicInfoType.FOLLOW);
                //return PageFragment.newInstance("", position, JkConfiguration.DynamicInfoType.FOLLOW);
            } else if (position == 1) {
                return PageAllFragment.newInstance("", position, JkConfiguration.DynamicInfoType.ALL);
            } else {
