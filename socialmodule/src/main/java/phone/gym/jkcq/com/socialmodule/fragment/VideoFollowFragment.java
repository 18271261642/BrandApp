...
public class VideoFollowFragment extends BaseMVPFragment<LikeView, LikePresent> implements LikeView, FriendView, ReportView, CommonAliView {
    ...
    public void onStart() {
        super.onStart();
        Log.e("VideoFollowFragment", "onStart->mCurrentPosition" + mCurrentPosition);
    }
    ...
    public void onResume() {
        ...
        isStart = true;
        if (currentBean != null ) {
           /* if (AppConfig.followListMap.containsKey(currentBean.getDynamicId())) {
                currentBean = AppConfig.followListMap.get(currentBean.getDynamicId());
            }
*/
        ...
        if (JkConfiguration.sCurrentFragmentTAG == JkConfiguration.FRAGMENT_COMMUNITY&& JkConfiguration.sCurrentCommunityFragment==JkConfiguration.FRAGMENT_FOLLOW) {
            startPlayer();
        }
    }
    ...
    public void startPlayer() {
        ...
        Log.e("startPlayer", "VideoFollowFragment mCurrentPosition:" + mCurrentPosition + "，gsyVideoManager.getCurrentState()：" + gsyVideoManager.getCurrentState());
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        Log.e("onHiddenChanged", "VideoFollowFragment onHiddenChanged" + hidden);
   ...
   /* public void initVideo() {
    ...
    protected void initEvent() {
        ...
        /*view_pause.setonViewOptin(new ClikeView.OnViewOption() {
            @Override
            public void onViewClick() {
                Log.e("onViewClick", "onViewClick");
                if (gsyVideoManager.getGSYVideoManager().isPlaying()) {
                    gsyVideoManager.onVideoPause();
                } else {
                    gsyVideoManager.onVideoResume(false);
            ...
            public void onViewLongClick() {
                Log.e("onViewClick", "onViewLongClick");
                showPhotoChoosePop();
            }
...
*/
    ...
    public static VideoFollowFragment newInstance(DynamBean bean, int position) {
        ...
        switch (messageEvent.getMsg()) {
            case MessageEvent.main_dynicid_update:
                ...
                if (updateDynicBean.getDynamicId().equals(currentBean.getDynamicId())) {
                    ...
                    currentBean.setCommentNums(updateDynicBean.getAllSum());
                }
                break;
            ...
            case MessageEvent.show_fragment_community:
                if (isStart&&JkConfiguration.sCurrentCommunityFragment==JkConfiguration.FRAGMENT_FOLLOW) {
                    startPlayer();
                }
                break;
            ...
            case MessageEvent.update_dynamic_like_state:
                ...
                if (resultLikeBean.getUserId().equals(currentUserId)&& resultLikeBean.getDynamicInfoId().equals(currentBean.getDynamicId())) {
                    ...
                    currentBean.setWhetherPraise(resultLikeBean.isWhetherPraise());
                    currentBean.setPraiseNums(resultLikeBean.getPraiseNums());
                }
                break;
