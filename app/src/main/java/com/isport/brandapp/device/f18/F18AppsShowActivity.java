...
public class F18AppsShowActivity extends BaseMVPTitleActivity<F18SetView,F18SetPresent> implements F18SetView {
    ...
    private List<F18AppsItemBean> setInitAppData(){
        ...
        f18AppsItemBeanList.add(new F18AppsItemBean(NotificationConfig.FLAG_TELEPHONE,"电话",false,R.drawable.icon_f18_phone));
        f18AppsItemBeanList.add(new F18AppsItemBean(NotificationConfig.FLAG_SMS,"短信",false,R.drawable.icon_f18_sms));
        f18AppsItemBeanList.add(new F18AppsItemBean(NotificationConfig.FLAG_EMAIL,"邮件",false,R.drawable.icon_f18_gmail));
        f18AppsItemBeanList.add(new F18AppsItemBean(NotificationConfig.FLAG_CALENDAR,"日历",false,R.drawable.icon_f18_calendar));
        f18AppsItemBeanList.add(new F18AppsItemBean(NotificationConfig.FLAG_WECHAT,"微信",false,R.drawable.icon_f18_wechat));
        ...
        f18AppsItemBeanList.add(new F18AppsItemBean(NotificationConfig.FLAG_OTHERS_APP,"其它",false,R.drawable.icon_f18_other));
